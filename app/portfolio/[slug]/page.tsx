        ...
        {uploadedMedia.length > 0 && (
          <section className="animate-fade-in-up animate-delay-600">
            ...
            <div className="mt-8 p-6 bg-red-50 border border-red-200 rounded-lg">
              <h3 className="font-semibold text-red-800 mb-2">🚨 Firebase Storage CORS Issue Detected</h3>
              <p className="text-red-700 text-sm mb-3">
                All Firebase Storage media is failing to load due to CORS restrictions. This is a Firebase configuration
                issue, not a code problem.
              </p>
              <div className="bg-red-100 p-4 rounded text-xs font-mono text-red-800 mb-4">
                <div className="mb-3 font-bold">SOLUTION: Configure Firebase Storage CORS</div>
                <div className="mb-2">1. Install Google Cloud CLI and authenticate:</div>
                <div className="bg-white p-2 rounded mb-2 text-black">
                  gcloud auth login
                  <br />
                  gcloud config set project stuph-studio
                </div>
                <div className="mb-2">2. Create cors.json file:</div>
                <div className="bg-white p-2 rounded mb-2 text-black">
                  {`[{
  "origin": ["https://www.stuph.co", "https://stuph.co"],
  "method": ["GET", "HEAD"],
  "maxAgeSeconds": 3600,
  "responseHeader": ["Content-Type", "Access-Control-Allow-Origin"]
}]`}
                </div>
                <div className="mb-2">3. Apply CORS configuration:</div>
                <div className="bg-white p-2 rounded text-black">
                  gsutil cors set cors.json gs://stuph-studio.firebasestorage.app
                </div>
              </div>
              <div className="text-red-600 text-xs mb-2">
                <strong>Why this happens:</strong> Firebase Storage blocks cross-origin requests by default. Your
                production domain needs explicit permission to access the storage bucket.
              </div>
              <div className="text-red-600 text-xs">
                <strong>After applying CORS:</strong> All uploaded media will display correctly in production. This is a
                one-time setup.
              </div>
            </div>
          </section>
